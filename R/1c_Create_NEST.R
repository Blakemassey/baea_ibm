...
nests_csv = read.csv(file.path("C:/Work/R/Data/BAEA/Nests/Original_Data",
              "IFW_20150427.csv")) %>%
            dplyr::rename(
              nest_site = PK_NestSite,
...
nests_shp <- readOGR(dsn="C:/ArcGIS/Data/BAEA/Nests/IFW_Nests",
               "IFW_Nests_2014")@data %>%
             dplyr::rename(nest_site = PK_NestSit, lat2 = POINT_Y,
               long2 = POINT_X) %>%
             dplyr::select(nest_site, long2, lat2) %>%
             ddply(., .(nest_site), function(x) tail(x,1))  # there are two 740A
...
nests_ifw_data <- nests_ifw_spdf_ll84@data %>%
                    arrange(nest_area) %>%
                    dplyr::select(nest_site:nest_comments, long_utm, lat_utm,
                      long, lat)

# Export CSV to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_ifw_data, file=file.path("C:/Work/R/Data/BAEA",
  "Nests/Nests_IFW_All.csv"), row.names=FALSE)
...
nests_2013 <- readOGR(dsn="C:/ArcGIS/Data/BAEA/Nests/IFW_Nests",
                "IFW_Nests_2014")@data %>%
              dplyr::filter(YearLastEa == "2013") %>%
              rename(nest_site = PK_NestSit) %>%
...
# Export CSV to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_2013_data, file=file.path("C:/Work/R/Data/BAEA",
  "Nests/Nests_IFW_2013_Active.csv"), row.names=FALSE)

# Export KML to "C:/ArcGIS/Data/BAEA/Nests/KMLs" folder
ExportKMLPoints(nests_2013_data, id = "nest_site", file="Nests Active 2103.kml",
  output_dir = kml_output_dir)

############################ NESTS INTACT ######################################

nests_intact_all <- nests_ifw_data %>%
                    filter(intact_at_last_obs == "Yes")

# Export CSV to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_intact_all, file=file.path("C:/Work/R/Data/BAEA",
  "Nests/Nests_IFW_Intact_All.csv"), row.names=FALSE)
...
# Export data to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_intact_last, file=file.path("C:/Work/R/Data/BAEA/Nests",
...
nests_study_csv <- read.csv(file.path("C:/Work/R/Data/BAEA/Nests/Original_Data",
  "Study_20170325.csv"))
...
nests_study <- left_join(nests_study_csv, nests_intact_all %>%
               ...
               dplyr::select(name:nest_area, intact_at_last_obs:nest_comments,
                 long_utm:lat)
...
# Export data to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_study_data, file=file.path("C:/Work/R/Data/BAEA",
  "Nests/Nests_Study.csv"), row.names=FALSE)

# Export KML to "C:/ArcGIS/Data/BAEA/Nests/KMLs" folder
ExportKMLPoints(nests_study_data, id="name", point_col_var="name",
  point_metadata="C:/Work/R/Data/BAEA/Nests/Nests_Color_Metadata.csv",
...
nests_study_intact <- nests_intact_all %>%
                      ...
                      slice(unique(n())) %>%
                      arrange(nest_site)
nests_study_intact <- as.data.frame(nests_study_intact)

# Export CSV to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_study_intact, file=file.path("C:/Work/R/Data/BAEA",
  "Nests/Nests_Study_Intact.csv"), row.names=FALSE)
...
# Export CSV to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_study_intact_last, file=file.path("C:/Work/R/Data/BAEA",
  "Nests/Nests_Study_Intact_Last.csv"), row.names=FALSE)
...
script <- "C:/Work/Python/Scripts/BAEA_GIS/Create_Nest_Features_From_CSVs.py"
...
nests_active <- read.csv("C:/Work/R/Data/BAEA/Nests/Nests_Study_Intact.csv")
...
# Export CSV to "C:/Work/R/Data/BAEA/Nests" folder
write.csv(nests_active, file.path("C:/Work/R/Data/BAEA/Nests",
  "Nests_Study_Intact_Active.csv"), row.names=FALSE)
...
# Export RData File ------------------------------------------------------------
save(nests_active, file="C:/Work/R/Data/R_Input/BAEA/nests_active.RData")
save(nests_active_spdf, file=file.path("C:/Work/R/Data/R_Input/BAEA",
  "nests_active_spdf.RData"))
