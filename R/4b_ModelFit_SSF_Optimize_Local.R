...
for (i in seq_along(ua_files)){
  ...
  if (end %in% c("cruise", "flight")){
    keep_covars <- c(
      # "open_water",
      #"developed", "forest",  "pasture", "shrub_herb",
      "eastness", "northness", "wind_class",
      "tpi", "tri", "roughness", #normally included
